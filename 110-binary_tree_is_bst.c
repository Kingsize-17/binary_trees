...
/**
 * binary_tree_is_bst - The function that checks if a binary tree is a valid Binary Search Tree
...
/**
 * btib_helper - The function that checks if a binary tree is a valid Binary Search Tree
 * @tree: The pointer to the root node of the tree to check
