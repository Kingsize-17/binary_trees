...
/**
 * bal - This measures the balance factor of a AVL
...
/**
 * successor - The function that gets the next successor i mean the min node in the right subtree
 * @node: The tree to be check
...
/**
 * avl_remove - The function that removes a node from a AVL tree
 * @root: The root of the tree
 * @value: The node with the value to be remove
 * Return: the tree changed
 */
