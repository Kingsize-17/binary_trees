...
/**
 * binary_tree_is_heap - The function that checks if a binary tree is a valid Max Binary Heap
...
/**
 * btih_helper - The Function that checks if a binary tree is a valid Max Binary Heap
 * @tree: The pointer to the root node of the tree to check
 *
 * Return: 1 if tree is a valid Max Binary Heap
 *         1 if tree is NULL
...
/**
 * btic_helper - The function taht checks if a binary tree is complete
 * @tree: the pointer to the root node of the tree to check
...
/**
 * binary_tree_size - The function that measures the size of a binary tree
